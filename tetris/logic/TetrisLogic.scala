...
import tetris.logic.Tetromino.getTetrominoType
...
class TetrisLogic(val randomGen: RandomGenerator,
  ...
  val randomNumber : Int = randomGen.randomInt(7)

  var activeTetromino: Tetromino = getTetrominoType(randomNumber, getAnchor)
  println(activeTetromino.bodyBlocks)
